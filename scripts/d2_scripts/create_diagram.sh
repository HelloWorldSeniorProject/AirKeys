...
# Parameter vars
source_dir="${HOME}/documentation/design/source"
output_dir="${HOME}/documentation/design/output"
input_file=''
output_file=''
...
while getopts "hif:o:a" flag; do
    ...
    o ) # provide the ouput filename and extension. See usage for more details.
        ...
        while [ -e ${output_dir}/${OPTARG} ] ; do
            echo "File already exists. Overwrite? (y/n)"
            read resp
                if [ ! $resp -eq "y"|"yes"|"Yes"|"Y" ] ; then
